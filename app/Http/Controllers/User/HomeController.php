...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $govts_job = Job::where('category_id', '1')->latest()->get(4);
        $private_job = Job::where('category_id', '2')->latest()->get(4);
        $student_job = Job::where('category_id', '3')->latest()->get(4);
        $update_job = Job::where('category_id', '4')->latest()->get(4);
