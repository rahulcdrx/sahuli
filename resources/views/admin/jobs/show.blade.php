            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!--{{ $job->job_image ?? '' }}-->
                            <img src="{{ asset('jobimage/'."$job->job_image") }}" width="200" height="200">
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <!--{{ $job->job_file ?? '' }}-->
                            <img src="{{ asset('jobimage/'."$job->job_file") }}" width="200" height="200">
                        </td>
                    </tr>
                     ...
                     <tr>
                        ...
                        <td>
                            <!--{{ $job->job_file ?? '' }}-->
                            <img src="{{ asset('jobimage/'."$job->job_social") }}" width="200" height="200">
                        </td>
                    </tr>
                    <tr>
                        <th>
